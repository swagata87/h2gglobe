...
public :
   ...
   Int_t           nvtx;
   Int_t           nPU;
   Float_t         mydipho_gensel;
   Float_t         mydipho_genfakeind;
   Float_t         mydipho_genpromptind;
   Float_t         mydipho_genfakee;
   Float_t         mydipho_genprompte;
   Float_t         mydipho_genfakeeta;
   Float_t         mydipho_genprompteta;
   Float_t         mydipho_genfakephi;
   Float_t         mydipho_genpromptphi;
   Float_t         weight;
   Float_t         rho;
   Int_t           nPho;
   Float_t         mva_legacy;
   ...
   TBranch        *b_nPU;   //!
   TBranch        *b_weight;   //!
   TBranch        *b_mydipho_gensel;   //!                                                                          
   TBranch        *b_mydipho_genfakeind;   //!
   TBranch        *b_mydipho_genpromptind;   //!
   TBranch        *b_mydipho_genfakee;   //!
   TBranch        *b_mydipho_genprompte;   //!   
   TBranch        *b_mydipho_genfakeeta;   //!         
   TBranch        *b_mydipho_genprompteta;   //! 
   TBranch        *b_mydipho_genfakephi;   //!
   TBranch        *b_mydipho_genpromptphi;   //!        
   TBranch        *b_rho;   //!
   TBranch        *b_nPho;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("opttree_Shashlik.root");
     /////    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("opttree_Sept15_8TeV_legacy.root");

      if (!f || !f->IsOpen()) {
	f = new TFile("opttree_Shashlik.root");
...
void Reweight::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("mydipho_gensel", &mydipho_gensel, &b_mydipho_gensel);
   fChain->SetBranchAddress("mydipho_genfakeind", &mydipho_genfakeind, &b_mydipho_genfakeind);
   fChain->SetBranchAddress("mydipho_genpromptind", &mydipho_genpromptind, &b_mydipho_genpromptind);
   fChain->SetBranchAddress("mydipho_genfakee", &mydipho_genfakee, &b_mydipho_genfakee);
   fChain->SetBranchAddress("mydipho_genprompte", &mydipho_genprompte, &b_mydipho_genprompte);
   fChain->SetBranchAddress("mydipho_genfakeeta", &mydipho_genfakeeta, &b_mydipho_genfakeeta);
   fChain->SetBranchAddress("mydipho_genprompteta", &mydipho_genprompteta, &b_mydipho_genprompteta);
   fChain->SetBranchAddress("mydipho_genfakephi", &mydipho_genfakephi, &b_mydipho_genfakephi);
   fChain->SetBranchAddress("mydipho_genpromptphi", &mydipho_genpromptphi, &b_mydipho_genpromptphi);
   ...
   fChain->SetBranchAddress("ESEffSigmaRR_pho", &ESEffSigmaRR_pho, &b_ESEffSigmaRR_pho);
