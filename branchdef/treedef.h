...
Float_t pho_smin[MAX_PHOTONS];
Float_t pho_alpha[MAX_PHOTONS];
Float_t pho_alpha_frac[MAX_PHOTONS];
Float_t pho_smin_frac[MAX_PHOTONS];
Float_t pho_smaj_frac[MAX_PHOTONS];
Float_t pho_sieie_frac[MAX_PHOTONS];
Float_t pho_sieip_frac[MAX_PHOTONS];
Float_t pho_sipip_frac[MAX_PHOTONS];
Float_t pho_r9_frac[MAX_PHOTONS];
Float_t pho_e2x2_frac[MAX_PHOTONS];
Float_t pho_e5x5_frac[MAX_PHOTONS];
Float_t pho_e3x3_frac[MAX_PHOTONS];
